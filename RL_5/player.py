    ...
    def q_learning(self):
        ...
        while episode <= self.episode_max and diff > self.threshold:
            ...
            while not end_episode:
                ...
                anneal_timesteps = self.settings.annealing_timesteps
                epsilon_initial = self.settings.epsilon_initial
                ...
                # alpha_final = 0.2
                #
                # lr = ScheduleLinear(anneal_timesteps, alpha_final, alpha_initial).value(current_total_steps)
...
class PlayerControllerRandom(PlayerController):
    ...
    def random_agent(self):
        ...
        # Matrix of elements: (state, action)
        n = np.zeros((ns, na))
        # ADD YOUR CODE SNIPPET BETWEEN EX. 1.2
